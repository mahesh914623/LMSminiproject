...
<body>
	<header>
		<nav>
			<div>
				<img alt=""
					src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQbul0UypZ2TtiGXg1OPUxQrEESRRPrFAEm-qPovqWlQq59YFEtQQAslyCpHRo3JWTh_Q&usqp=CAU">
			</div>
			...
			<span><i class="fa-solid fa-user"></i> <a href="Registration.jsp" >CREATE ACCOUNT</a> 
				</span>
		</nav>
	</header>
	<section>
		...
		<div>
			Welcome<br>Learning Management System<br>Platform
		</div>
	</section>
	<footer><i class="fa-brands fa-facebook"></i><i class="fa-brands fa-instagram"></i><i class="fa-brands fa-square-whatsapp"></i><i class="fa-brands fa-square-x-twitter"></i></footer>
</body>
</html>